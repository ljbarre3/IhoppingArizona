...
const AboutJourneyPage: React.FC = () => {
    ...
    return (
        <Box style={{ marginBottom: "5rem", width: "99%" }}>
        <Stack gap={"xl"}  >
            <Grid>
            <Grid.Col style={{textAlign: "left", color: "white", opacity: .87, boxShadow: '0 8px 20px 0 rgba(0, 0, 0, 0.3)',
                ...
                <Title style={{textAlign: "center"}}>Our Journey To Arizona's <span style={{ color: theme.colors.customBlue[8] }}><b>IHOP</b></span>s</Title>
            ...
            <Grid.Col span={4} offset={2}
                ...
                <Box style={{margin: "1rem"}}>
                    ...
                    <Text size="xl">Austins Text goes here.</Text>
                </Box>
            </Grid.Col>
            <Grid.Col span={4} style={{boxShadow: '0 8px 20px 0 rgba(0, 0, 0, 0.3)',
                borderTopRightRadius: "1Rem",
